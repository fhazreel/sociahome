						...
						<div class="module">
							...
							<div class="module-body table">
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									<tbody>
										<?php $st='closed';
										$query=mysqli_query($con,"select tblcomplaints.*,resident.fullName as name,category.categoryName as catname from tblcomplaints join resident on resident.id=tblcomplaints.userId join category on category.id=tblcomplaints.category where tblcomplaints.complaintNumber='".$_GET['cid']."'");
										...
										<tr>
											...
											<td colspan="5"> <?php $cfile=$row['complaintFile'];
												...
												<a href="../resident/complaintdocs/<?php echo htmlentities($row['complaintFile']);?>" target="_blank"/> View File</a>
												<?php } ?>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<?php if($row['status']=="closed"){
												...
												<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/sociahome/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
												<button type="button" class="btn btn-primary">Take Action</button></td>
												</a><?php } ?></td>
												<td colspan="4"> 
												<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/sociahome/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');" title="Update order">
