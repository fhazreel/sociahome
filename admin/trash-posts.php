...
$query=mysqli_query($con,"update announcements set Is_Active=1 where id='$postid'");
if($query)
{
...
if($_GET['presid'])
{
    ...
    $query=mysqli_query($con,"delete from  announcements  where id='$id'");
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									?>									
										<tr>
											...
											<td><?php echo htmlentities($row['announcecategory']);?></td>
											<td> <?php echo htmlentities($row['announcesubcategory']);?></td>
											<td><a href="trash-posts.php?pid=<?php echo htmlentities($row['postid']);?>&&action=restore" onclick="return confirm('Do you really want to restore ?')"> 
												<button type="button" class="btn btn-primary">Restore</button>
												
												<a href="trash-posts.php?presid=<?php echo htmlentities($row['postid']);?>&&action=perdel" onclick="return confirm('Do you reaaly want to delete ?')">
