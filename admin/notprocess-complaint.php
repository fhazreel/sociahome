...
<tbody>
<?php 
$query=mysqli_query($con,"select tblcomplaints.*,resident.fullName as name from tblcomplaints join resident on resident.id=tblcomplaints.userId where tblcomplaints.status is null ");
