...
{
$userid=$_GET['uid'];
$query=mysqli_query($con,"delete from resident where id='$userid'");
							...
							<div class="module-body table">
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									?>									
										...
										<td>
												<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/sociahome/admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
